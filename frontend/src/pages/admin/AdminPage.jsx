    ...
    <>
      <div className="admin-card">
        <div className="admin-card__top">
          ...
          <button className="btn-add" onClick={() => setModal({ tipo: 'crear' })}>+ Nuevo usuario</button>
        </div>
                    ...
                    <tr key={u.id}>
                      ...
                      <td>
                        <div className="admin-actions">
                          <button className="btn-admin btn-admin--primary" onClick={() => abrirEditar(u)}>Editar</button>
                          <button className="btn-admin btn-admin--warning" onClick={() => setModal({ tipo: 'unlock', usuario: u })}>Desbloquear</button>
                          <button className="btn-admin btn-admin--danger" onClick={() => setModal({ tipo: 'baja', usuario: u })}>Dar baja</button>
                          <button className="btn-admin btn-admin--danger" onClick={() => setModal({ tipo: 'expulsar', usuario: u })}>Expulsar</button>
                        </div>
                      </td>
                    </tr>
                  ))}
    ...
    <>
      <div className="admin-card">
        <div className="admin-card__top">
          ...
          <button className="btn-add" onClick={() => setModal({ tipo: 'crear' })}>+ Nuevo rol</button>
        </div>
        {loading ? <div className="admin-empty">Cargando...</div>
                ...
                <tbody>
                  {roles.map((r) => (
                    <tr key={r.id}>
                      ...
                      <td>{!r.es_sistema && <button className="btn-admin btn-admin--danger" onClick={() => setModal({ tipo: 'eliminar', rol: r })}>Eliminar</button>}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
