...
$PerfilDtoCopyWith<PerfilDto> get copyWith => _$PerfilDtoCopyWithImpl<PerfilDto>(this as PerfilDto, _$identity);
...
@override
String toString() {
  return 'PerfilDto(id: $id, correo: $correo, nombre: $nombre, apellido: $apellido, telefono: $telefono, estado: $estado, creadoEn: $creadoEn)';
}
...
/// @nodoc
abstract mixin class $PerfilDtoCopyWith<$Res>  {
  factory $PerfilDtoCopyWith(PerfilDto value, $Res Function(PerfilDto) _then) = _$PerfilDtoCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$PerfilDtoCopyWithImpl<$Res>
    implements $PerfilDtoCopyWith<$Res> {
  _$PerfilDtoCopyWithImpl(this._self, this._then);

  final PerfilDto _self;
  final $Res Function(PerfilDto) _then;
...
/// Adds pattern-matching-related methods to [PerfilDto].
extension PerfilDtoPatterns on PerfilDto {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PerfilDto value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _PerfilDto() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PerfilDto value)  $default,){
final _that = this;
switch (_that) {
case _PerfilDto():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PerfilDto value)?  $default,){
final _that = this;
switch (_that) {
case _PerfilDto() when $default != null:
return $default(_that);case _:
...
class _PerfilDto implements PerfilDto {
  const _PerfilDto({required this.id, required this.correo, required this.nombre, required this.apellido, required this.telefono, required this.estado, required this.creadoEn});
  factory _PerfilDto.fromJson(Map<String, dynamic> json) => _$PerfilDtoFromJson(json);
...
@pragma('vm:prefer-inline')
_$PerfilDtoCopyWith<_PerfilDto> get copyWith => __$PerfilDtoCopyWithImpl<_PerfilDto>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$PerfilDtoToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PerfilDto&&(identical(other.id, id) || other.id == id)&&(identical(other.correo, correo) || other.correo == correo)&&(identical(other.nombre, nombre) || other.nombre == nombre)&&(identical(other.apellido, apellido) || other.apellido == apellido)&&(identical(other.telefono, telefono) || other.telefono == telefono)&&(identical(other.estado, estado) || other.estado == estado)&&(identical(other.creadoEn, creadoEn) || other.creadoEn == creadoEn));
}
...
/// @nodoc
abstract mixin class _$PerfilDtoCopyWith<$Res> implements $PerfilDtoCopyWith<$Res> {
  factory _$PerfilDtoCopyWith(_PerfilDto value, $Res Function(_PerfilDto) _then) = __$PerfilDtoCopyWithImpl;
@override @useResult
$Res call({
 String id, String correo, String nombre, String apellido, String telefono, String estado, DateTime creadoEn
});
...
/// @nodoc
class __$PerfilDtoCopyWithImpl<$Res>
    implements _$PerfilDtoCopyWith<$Res> {
  __$PerfilDtoCopyWithImpl(this._self, this._then);

  final _PerfilDto _self;
  final $Res Function(_PerfilDto) _then;
